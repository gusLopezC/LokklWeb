...
export class CancelReservationComponent implements OnInit {
  ...
  CancelarReservacionGuia(forma: NgForm) {
    ...
    this._reservasService.cancelarReservacionGuia(this.pedido, forma.value.MotivoCancelacion, this.token)
      .subscribe((resp: any) => {
        swal.fire('Cancelación exitosa', 'Revisa tu correo para ver todos los detalles', 'success');

        this.router.navigate(['/users/myreservations']);
      });
